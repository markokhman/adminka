                            ...
                            <div class="pics">
                                ...
                                <?php $places = Images::model()->findAllByAttributes(array('owner_id'=>$model->cert_id, 'type'=>'image-certificate'));
                                   foreach($places as $pl){?>
                                    <li><a href="<?php echo Yii::app()->createUrl('certificate/imageCrop', array('id'=>$pl->img_id));?>" title="" rel="prettyPhoto"><img src="<?php echo Yii::app()->baseUrl.'/images/'.$pl->img_id.'-'.$pl->type.'.'.$pl->extension;?>" alt="" width="120"  /></a>
                                        <div class="actions">                                                
		            ...
		            <div class="widget">
		                ...
		                <div class="body">
		                    ...
		                    <div class="list arrowGreen pt12">
		                        ...
		                        <ul>
		                             <li><?php if($model->star_min===$model->star_max) echo $model->star_min; else echo $model->star_min.'-'.$model->star_max;?> звезд</li>
		                        </ul>
		                    </div>
		                </div>
		            </div>
